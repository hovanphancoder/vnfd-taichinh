...
<head>
	...
	<!--=== custom css ===-->
    <title>LAD Interior | About us</title>
  </head>
  <body class="int_dark_bg">
	...
	<div class="int_main_wraapper">
		<div class="int_content_wraapper int_content_margin">
			<div class="int_header_wrapper int_header_style1">
						...
						<div class="col-lx-12 col-lg-6 col-md-12 offset-lg-6 offset-md-0 pl-0 pr-0">
							<div class="about_contentbox">
								<div class="about_content">
									...
									<h2 class="about_head1">We Build Our Projects With Your <span>Dreams And Ideas.</span></h2>
									...
									<a href="portfolio-dark.html" class="int_btn">View Project <span class="btn_caret"><i class="fas fa-caret-right"></i></span></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="int_darkab_service_section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="int_heading">
		...
		<div class="int_dark_client_section">
			<div class="container">
				<div class="int_client_logo_section_style2">
					<ul>
						<li><img src="assets/images/dark_client1.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client8.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client9.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client4.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client9.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client6.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client7.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client8.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client9.png" class="img-fluid" alt="image" /></li>
						<li><img src="assets/images/dark_client10.png" class="img-fluid" alt="image" /></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 order-last">
							<div class="about_contentbox">
								<div class="about_content">
									...
									<p class="about_deatils"><span class="t_color">Tempor incididunt ut labore et dolore</span> magna aliqua. Ut enim ad minim veniam quis nostruercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. <span class="t_color">Duis aute irure dolor in reprehei voluptate</span> velit esse cillum dolore eu fugiat nulla pariatur Duis aute irure dolor in reprehei voluptate veliet esse cillum dolore eu fugiat nulla pariatur..
									<p>
									<p class="about_deatils">Ut enim ad minim veniam quis nostruercitation ullamco laboris nisi ut aliquip ex ea commonsequat Duis aute irure dolor reprehei voluptate  esseu fugiat nulla pariatur.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="about_imgbox">
								<div class="about_img">
									<img src="assets/images/int_about01.jpg" class="img-fluid parent_img" alt="image" />
									<div class="child_imgbox">
										<img src="assets/images/int_about02.jpg" class="img-fluid child_img" alt="image" />
									</div>
								</div>	
							</div>
						</div>
							...
							<div class="swiper-container gallery-thumbs">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="swi_user">
											<img src="assets/images/testimonial/int_v1_testimonial01.jpg" class="img-fluid" alt="images" />
									...
									<div class="swiper-slide">
										<div class="swi_user">
											<img src="assets/images/testimonial/int_v1_testimonial02.jpg" class="img-fluid" alt="images" />
											<svg xmlns="http://www.w3.org/2000/svg" width="39px" height="26px">
												<path fill-rule="evenodd"  fill="rgb(198, 164, 126)"
												 d="M39.000,-0.004 C28.170,6.341 22.203,18.207 20.000,23.422 L20.000,25.997 C20.000,25.997 19.834,25.500 19.500,24.647 C19.166,25.500 19.000,25.997 19.000,25.997 L19.000,23.422 C16.797,18.207 10.830,6.341 -0.000,-0.004 L19.500,2.922 L39.000,-0.004 Z"/>
											</svg>
									...
									<div class="swiper-slide">
										<div class="swi_user">
											<img src="assets/images/testimonial/int_v1_testimonial03.jpg" class="img-fluid" alt="images" />
											<svg xmlns="http://www.w3.org/2000/svg" width="39px" height="26px">
												<path fill-rule="evenodd"  fill="rgb(198, 164, 126)"
												 d="M39.000,-0.004 C28.170,6.341 22.203,18.207 20.000,23.422 L20.000,25.997 C20.000,25.997 19.834,25.500 19.500,24.647 C19.166,25.500 19.000,25.997 19.000,25.997 L19.000,23.422 C16.797,18.207 10.830,6.341 -0.000,-0.004 L19.500,2.922 L39.000,-0.004 Z"/>
											</svg>
