				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
						<div class="int_home_crumbs">
							<ul>
								<li><a href="index.html">Home // </a><span> our services</span></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row no-gutters">
							...
							<a href="javascript:;">
								<div class="service_box serivce_first">
									<div class="service_img">
										<img src="assets/images/services/int_servies01.jpg" class="img-fluid" alt="images">
									</div>
									<div class="service_content">
										<h4>Floor plan</h4>
										<p>Dolore magna aliqua Ut enim adveniam quis nostrud exercitation.</p>
									</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<a href="javascript:;">
								<div class="service_box serivce_second">
									<div class="service_img">
										<img src="assets/images/services/int_servies02.jpg" class="img-fluid" alt="images">
									</div>
									<div class="service_content">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<a href="javascript:;">
								<div class="service_box serivce_first">
									<div class="service_img">
										<img src="assets/images/services/int_servies04.jpg" class="img-fluid" alt="images">
									</div>
									<div class="service_content">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<a href="javascript:;">
								<div class="service_box serivce_second">
									<div class="service_img">
										<img src="assets/images/services/int_servies03.jpg" class="img-fluid" alt="images">
									</div>
									<div class="service_content">
										<h4>Construction</h4>
										<p>Dolore magna aliqua Ut enim adveniam quis nostrud exercitation.</p>
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="int_service_box2">
								<svg xmlns="http://www.w3.org/2000/svg" width="38px" height="60px">
