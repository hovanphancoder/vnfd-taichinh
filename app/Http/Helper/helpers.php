...
class Helper {
    ...
    public static function pathFilemanger() {
        if ($_SERVER['HTTP_HOST'] == "localhost")
            $pathtinymce = "/nhatui/public/admin_assets/filemanager/";
        else {
            $pathtinymce = "http://nhatuidecor.tuvanthietkeweb.net/public/admin_assets/filemanager/";
        }
        return $pathtinymce;
    }

    public static function generateBarcodeNumber() {
	    $number = mt_rand(501, 3110); 
    ...
    function pathFilemanger() {
        if ($_SERVER['HTTP_HOST'] == "localhost")
            $pathtinymce = "http://localhost/nhatui/public/admin_assets/filemanager/";
        else {
