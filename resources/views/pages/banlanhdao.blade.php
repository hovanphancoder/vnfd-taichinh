                        ...
                        <div class="team-area default-padding bottom-less">
                                <div class="row">
                                    ...
                                    <div class="team-items text-center team-standard ">
                                        ...
                                        <h2>Ban Tổng Giám Đốc</h2>
                                        <!-- Single Item -->
                                        
                                        @if($listPost)
                                        <div class="col-md-12 col-sm-12 single-item">
                                            <div class="item">
                                                <div class="thumb"><a href="{!! url($listPost[1]->slug) !!}">
                                                    <img src="{!! url('images/upload/post/'.$listPost[1]->image) !!}" width="300px" alt="Thumb">
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h4>{!! $listPost[1]->title !!}</h4>
                                                    <div>
                                                         {!! $listPost[1]->description !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
