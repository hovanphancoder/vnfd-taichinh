...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- Videos Table Row Start -->
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\VideoController@create')!!}" method="post" enctype="multipart/form-data">
                        <div class="row">
                                   ...
                                   <div class="tab-content">
                                        ...
                                        <div class="tab-pane {!! ($key == 1)?'active':'' !!}" id="tab_{{$lang}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="language-{{$key}}-path" placeholder="Enter path" value="">
                                            </div>
                                            <div class="form-group">
                                                <img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label class="control-label" for="embed">Embed</label>
                                                <input type="text" name="language-{{$key}}-embed" placeholder="Enter embed" value="">
                                            </div>
                                            <div class="form-group">
                                                <img class="marrig5" src="{!! url('admin_assets/img/'.$key.'.png') !!}"><label class="control-label" for="description">Description</label>
                                                <textarea name="language-{{$key}}-description" class="form-control" id="description" placeholder="Description"></textarea>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="create-page-right">
                                    ...
                                    <div class="page-img-upload">
                                        ...
                                        <img src="{!!url('images/upload/video/defaultimage.jpg')!!}" alt="Breadcrumb">
