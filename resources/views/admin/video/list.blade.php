    ...
    <div class="container-fluid">
        ...
        <section class="content-header">
            <div style="text-align: right">
                <a href="{!!url('admin/video/list')!!}" class="btn btn-default  btn-flat"><span class="glyphicon glyphicon-refresh"></span></a>
                <a href="{!!url('admin/video/add')!!}" class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-plus-sign"></span> Add New</a>
                    ...
                    <div class="table-responsive">
                        <table id="page-list" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{!!$count+1!!}</td>
                                    <td><a href="{!!url('admin/video/view/'.$item->id)!!}" class="page-table-success">{!! $item->name !!}</a></td>
                                    <td>{!! $item->description !!}</td>
                                   <td>{!!date('d/m/Y H:i:s', strtotime($item->created_at))!!}</td>
                                   <td>{!!date('d/m/Y H:i:s', strtotime($item->updated_at))!!}</td>
                                    <td>
                                         <a href="{!!url('admin/page/view/'.$item->id)!!}" class="page-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script>
    ...
    if (r == true) {
    window.location.assign("{!!url('admin/video/delete')!!}" + "/" + id);
    } else {
