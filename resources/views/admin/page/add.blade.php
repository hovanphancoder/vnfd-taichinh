...
<script>
    tinymce.init({
        ...
        toolbar2: "| responsivefilemanager | fontsizeselect | fontselect | forecolor backcolor | link unlink anchor | image media | fullscreen preview code",
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\PageController@doAdd')!!}" method="POST" enctype="multipart/form-data">
                        <div class="row">
									  ...
									  <?php $count=1;?>
										...
										<div class="tab-pane {!! ($key == 1)?'active':'' !!}" id="tab_{{$lang}}">
											<div class="form-group">
												...
												<input type="text" name="language-{{$key}}-title" placeholder="Enter Page Title" value=''>
											</div>
											
											<div class="form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Slug</label>
												<input type="text" name="language-{{$key}}-slug" placeholder="Enter Page Slug" value=''>
											</div>
                            ...
                            <div class="col-md-3">
                                <div class="create-page-right">
                                    ...
                                    <div class="page-img-upload">
                                        ...
                                        <img src="{!!url('images/upload/page/defaultimage.jpg')!!}" alt="Breadcromb">
