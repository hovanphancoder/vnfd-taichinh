...
<div class="page-content">
    <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="seipkon-breadcromb-left">
                                <h3>Edit Page</h3>
                                <a target="blank" href="{!!url('/'.$view->slug)!!}">Xem nhanh</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\PageController@edit',$view->id)!!}" method="post" enctype="multipart/form-data">
                        <div class="row">
                                   ...
                                   <div class="tab-content">
										...
										<div class="tab-pane {!! ($key == 1)?'active':'' !!}" id="tab_{{$lang}}">
											<div class="form-group">
												...
												<input type="text" name="language-{{$key}}-title" placeholder="Enter Name" value="{!!$viewPage[$key-1]['title']!!}">
											</div>

											<div class="form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Slug</label>
												<input type="text" name="language-{{$key}}-slug" placeholder="Enter Page Slug" value="{!!$viewPage[$key-1]['slug']!!}">
											</div>
											<div class="form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label class="control-label" for="message">Description</label>
												<textarea name="language-{{$key}}-description" class="form-control" id="message" placeholder="Description">{!!$viewPage[$key-1]['description']!!}</textarea>
											</div>

											<div class="page-editor-box form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Content</label>
												<textarea name="language-{{$key}}-content" id="mytextarea_{{$key}}">{!!$viewPage[$key-1]['content']!!}</textarea>
											</div>
										</div>
										@endforeach
									</div>
                            ...
                            <div class="col-md-3">
                                <div class="create-page-right">
                                    ...
                                    <div class="page-img-upload">
                                        ...
                                        <img src="{!!url('images/upload/page/'.$view->image)!!}" alt="Breadcromb">
