...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\PostController@projecttypeCreate')!!}" method="post" enctype="multipart/form-data">
                        <div class="row">
									  ...
									  @if(config('app.locales'))
										...
										<div class="{{($count++==1)?'active':''}} tab-pane" id="tab_{{$lang}}">
											<div class="form-group">
												...
												<input type="text" name="language-{{$key}}-name" placeholder="Enter Category Title" value=''>
											</div>

											<div class="form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Title</label>
												<input type="text" name="language-{{$key}}-slug" placeholder="Enter Category Title" value=''>
											</div>
