...
if ($_SERVER['HTTP_HOST'] == "localhost")
    ...
    $pathtinymce = "http://nhatui.tuvanthietkeweb.net/public/admin_assets/filemanager/";
}
?>
									...
									<ul class="nav nav-tabs" role="tablist">
                                      ...
                                      @if(config('app.locales'))
                                        @foreach(config('app.locales') as $lang)
                                          <li class="active"><a href="#tab_{{$lang}}" role="tab" data-toggle="tab">{{trans('general.lang_'.$lang)}}</a></li>
                                        @endforeach
                                        @endif
                                      ...
                                      <?php $count=1;?>
                                        ...
                                        <div class="tab-pane active" id="tab_{{$lang}}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="language-{{$key}}-title" placeholder="Enter Name" value='{!!$viewPost[$key-1]["title"]!!}' required>
                                            </div>

                                            <div class="form-group">
                                                <img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Slug</label>
                                                <input type="text" name="language-{{$key}}-slug" placeholder="Enter Post Slug" value="{!!$viewPost[$key-1]['slug']!!}">
                                            </div>
                                            <div class="form-group">
                                                <img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label class="control-label" for="message">Description</label>
                                                <textarea name="language-{{$key}}-description" class="form-control" id="message" placeholder="Description">{!!$viewPost[$key-1]['description']!!}</textarea>
                                            </div>

                                            <div class="page-editor-box form-group">
                                                <img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label>Content</label>
                                                <textarea name="language-{{$key}}-content" id="mytextarea_{{$key}}">{!!$viewPost[$key-1]['content']!!}</textarea>
                                            </div>
                                        </div>
                                        @endforeach
                                        @endif
