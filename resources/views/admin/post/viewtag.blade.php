...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\TagController@edit', $item->id)!!}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <input type="hidden" name="_token" value="{!!csrf_token()!!}">
                            <input type="hidden" name="old_image" value="{!! $item->image?$item->image:'' !!}">
                            <div class="col-md-4">
                                <div class="create-page-left">
                                    <div class="form-group">
                                        <img class="marrig5" src="{!!url('admin_assets/img/'.session('locale').'.png')!!}"><label>Tên Tag</label>
                                        <input type="text" name="name" placeholder="Tag Name" value="{!! $item->name !!}" >
                                    </div>

                                    <div class="form-group">
                                        <img class="marrig5" src="{!!url('admin_assets/img/'.session('locale').'.png')!!}"><label>Slug</label>
                                        <input type="text" name="slug" placeholder="Tag Slug" value="{!! $item->slug !!}" >
                                    </div>
                                    ...
                                    <div class="page-img-upload">
                                        ...
                                        <div class="feature__image">
                                            <img src="{!! url('images/upload/tag/'.$item->image) !!}" alt="Breadcromb">
                                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{!! url('/387/admin/post/tag/'.$tag['id']) !!}" class="page-table-info" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
