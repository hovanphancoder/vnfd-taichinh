...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-box">
                    <form action="{!!action('Admin\ProductController@editTrademark', $id)!!}" method="post" enctype="multipart/form-data">
									  ...
									  @if(config('app.locales'))
										...
										<div class="{{($count++==1)?'active':''}} tab-pane" id="tab_{{$lang}}">
											<div class="form-group">
												...
												<input type="text" name="language-{{$key}}-name" placeholder="Enter Page Title" value="{!!$viewTrademarkLanguage[$key-1]['name']!!}" required>
											</div>
											
											<div class="form-group">
												<img class="marrig5" src="{!!url('admin_assets/img/'.$key.'.png')!!}"><label class="control-label" for="message">Description</label>
												<textarea name="language-{{$key}}-description" class="form-control" id="message" placeholder="Description">{!!$viewTrademarkLanguage[$key-1]['description']!!}</textarea>
											</div>
										</div>
										@endforeach
										@endif
                            ...
                            <div class="col-md-3">
                                <div class="create-page-right">
                                    ...
                                    <div class="page-img-upload">
                                        ...
                                        <img src="{!!url('images/upload/product/'.$viewTrademark->image)!!}" alt="{!!$viewTrademark->name!!}">
                                        <div class="product-upload btn btn-info">
                                            <i class="fa fa-upload"></i>
                                            Upload Image
                                            <input type="file" class="custom-file-input form-control" id="customFile" name="image">
                                            <input type="hidden" value="{!!$viewTrademark->image!!}" name="old_image">
                                        </div>
                                    </div>
                                </div>
                            </div>
